<?php 
    ...
    public $pkeys = 'id';
    public $fieldType = array("id"=>PDO::PARAM_INT, "varchar10_required"=>PDO::PARAM_STR, "datetime_fld"=>PDO::PARAM_STR, "file_fld"=>PDO::PARAM_STR, "test_company_id"=>PDO::PARAM_INT, "test_company2_id"=>PDO::PARAM_INT, "image_fld"=>PDO::PARAM_STR);
    public $storeType = array("id"=>'none', "varchar10_required"=>'none', "datetime_fld"=>'none', "file_fld"=>'none', "test_company_id"=>'dropdown', "test_company2_id"=>'dropdown', "image_fld"=>'none');
    ...
    public function read ($page=1, $page_size=40, $order=array(), $readType='gridlist', $gridFilter=array(), $activeFilter=null, $filterParams=array(), $phpFilter=null, $phpFilterParams=array(), $group=null, $node=null, $action=null, $actionData=null, $countMode='all') {
        ...
        try {
            if ($order === '*readByPk*') {
                ...
                $sql = "SELECT `test`.`id`,`test`.`varchar10_required`,`test`.`datetime_fld`,`test`.`file_fld`,`test`.`image_fld`,`test`.`test_company_id`,`test`.`test_company2_id` 
...
if($readType === 'exportlist')
    $sql = "SELECT 
                `test`.`id` AS `Id`, `test`.`varchar10_required` AS `Varchar10 Required`, `test`.`datetime_fld` AS `Datetime Fld`, `test`.`file_fld` AS `File Uploader`, `test`.`image_fld` AS `Image File Uploader` 
...
$sql .= $criteria . $orderStr . $limit;               
            ...
            if ($action === 'add') {
                ...
                $blankRecord = array("id"=>null, "varchar10_required"=>null, "datetime_fld"=>null, "file_fld"=>null, "image_fld"=>null, "test_company_id"=>null, "test_company2_id"=>null);
    ...
    public function duplicate($pkValues, $setValues=array(), $targetDatabaseId=null) {        
        ...
        try {
            ...
            $sql = "SELECT 1 AS to_prohibit_error_if_none, `id`, `varchar10_required`, `datetime_fld`, `file_fld`, `image_fld`, `test_company_id`, `test_company2_id`
    ...
    public function getCaptions() {
    	return array('Id', 'Varchar10 Required', 'Datetime Fld', 'File Uploader', 'Company Head-office', 'Company', 'Image File Uploader' );
    }
    public function getSqlParts() {
		return array('model' => 'Table',
					 'containerName' => "Tablexx1xxdibexComponents",
					 'selectFields' => "`test`.`id`,`test`.`varchar10_required`,`test`.`datetime_fld`,`test`.`file_fld`,`test`.`image_fld`,`test`.`test_company_id`,`test`.`test_company2_id`",
