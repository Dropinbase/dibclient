<?php 
    Class Tablexx1xxdibtestConsultantGrid { 
    public $count = 0;
        ...
        if(strpos($activeFilter, 'dibexEvents_dibtestConsultantGrid') === 0) {
            ...
            if (array_key_exists('submitItemAlias_parent_companyId',$filterParams)) {
                ...
                if(is_array($value) || $value === ':submitItemAlias_parent_companyId')
                    // ***TODO LogERROR!
                    //return array('error',"Error! The filter parameter 'submitItemAlias_parent_companyId' for filter '' on dibtestConsultantGrid is missing from submitted values.");
...
$sql .= $criteria . $orderStr . $limit;               
    ...
    public function getSqlParts() {
		return array('model' => 'Table',
					 'containerName' => "Tablexx1xxdibtestConsultantGrid",
